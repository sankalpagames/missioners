...
//              turret — у подобъекта типа 34 (турель): fov — сектор в градусах вокруг курса f, range — дальность, aim — прицел, с, reload — перезарядка, с.
...
const LEVEL = {
  stations: [
    { x:6, y:0, ang:0, spawn:{x:16, y:0}, airlock:{x:16, y:0}, subs:[   // ARK-041
      ...
      {type:34, dx:-2, dy:-6, f:90, turret:{fov:140, range:120, aim:3, reload:10}},   // турель
    ] },
