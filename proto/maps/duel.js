...
const LEVEL = {
  meta: { id:'duel', name:'Две станции', v:3, format:2 },
  terrain: {
    canyon: {
    ...
    bounds: {x0:-250, y0:-650, x1:1150, y1:850},
    bumps: [
    ],
  },
  sites: [
    { x:10, y:3, ang:0 },   // площадка 1 — 450 м до среднего ретранслятора, 648 до входного: без среднего вглубь не пройти (как и площадке 2: 455 и 933)
