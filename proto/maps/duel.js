...
const LEVEL = {
  meta: { id:'duel', name:'Две станции', v:1, format:2 },
  terrain: {
    canyon: {
  ...
  sites: [
    { x:6, y:0, ang:0 },   // площадка 1
    { x:906, y:0, ang:180 },   // площадка 2
  ],
  layouts: { 1:[0], 2:[0,1] },
  pois: [
  ...
  objects: [
    {id:1, type:17, x:456, y:0, scenery:1},   // мачта
    {id:2, type:35, x:460, y:3},   // ретранслятор
    {id:3, type:26, x:466, y:528, scenery:1},   // темнота
    {id:4, type:27, x:453, y:518, scenery:1},   // борозды
    ...
    {id:8, type:31, x:527.6, y:585.5, scenery:1},   // вода
