...
- Спрайт и сонарный след одного объекта — разного размера (платформа 15 м против круга r 10): при доработке столкновений свести к одной таблице.
...
2. Пирамидка тропы — контрастнее (см. §7).
3. Крупные обломки у подножия обрыва (2 листа), чтобы осыпь читалась с 25 м.
4. Второй лист штабеля для ящиков как отдельных объектов не нужен — ящики 13/14/15 остаются в описании и журнале, а в кадре — частью штабеля.
