...
- Кредиты SpriteCook на 19.09.2026 — 247 (`get_credit_balance`).
...
5. **Ящик** (типы 13 запечатан / 14 вскрытый, по 1 м): с 20.09.2026 штабель — указатель без спрайта, ящики — объекты; пока рисуются листом `crates_sheet` в масштабе 1 м (маленький штабель — заглушка). Нужен лист одного ящика с маркировкой, второе состояние — крышка снята. Надпись 15 — плоский рисунок на грунте или на борту ящика, отдельный лист не нужен.
